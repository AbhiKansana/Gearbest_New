...
function Navbar() {
  return (
    ...
    <Box  display='flex' gap='150px'>
        ...
        <Image cursor='pointer' w='230px' h='50px' src='https://uidesign.gbtcdn.com/GB/images/promotion/2019/a_evan/Gearbest/logo_gearbest.png' ></Image>
        </Center>
        <Box  flexGrow='1'>
            ...
            <Flex p='10px' gap='40px' flexDir='row-reverse'  >
                <Center cursor='pointer'  gap='10px'><Icon boxSize='1.5rem' as={AiOutlineShoppingCart}/><Text fontSize='1.25rem'>Cart</Text></Center>
                <Center cursor='pointer' gap='10px'><Icon boxSize='1.5rem' as={AiOutlineHeart}/><Text fontSize='1.25rem'>Favourites</Text></Center>
                <Center cursor='pointer' gap='10px'><Icon boxSize='1.5rem' as={CgProfile}/><Text fontSize='1.25rem'>Sing In</Text></Center>
